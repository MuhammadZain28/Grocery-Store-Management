...
void signIn(string x, string y);                                                                // sign in 

double sort(double arr1[], double arr2[], int size);                                            // sort discount list to apply right discount
                        ...
                        if (check == 2)
                        {
                            for (int i = 0; i < dsize; i++)
                            {
                                ...
                                if(discountCoupons[i] == 0)
                                {
                                    ...
                                    while (productValidation(discountCoupons[i],discountPercentage[i],1));
...
double sort(double arr1[], double arr2[], int size)
{
...
bool saveProducts(string (&grocery)[psize], int (&cost)[psize], int (&sale)[psize], int (&stock)[psize], int size)
{
    ...
    for (int i = 0; i < 15; i++)
    {
        ...
        {
            fout << discountCoupons[i] << "," << discountPercentage[i] << "," << maxDiscount << endl;
        }
    }
    fout.close();
}
